...
dependencies {
    compile ('com.mapbox.mapboxsdk:mapbox-android-sdk:0.7.1-SNAPSHOT@aar'){
        transitive=true
    }
}
```
...
1. Download the [mapbox-android-sdk-0.7.0.apklib](http://search.maven.org/remotecontent?filepath=com/mapbox/mapboxsdk/mapbox-android-sdk/0.7.0/mapbox-android-sdk-0.7.0.apklib).
2. Extract the source code and import it directly into the Eclipse project
  * `jar xf mapbox-android-sdk-0.7.0.apklib`
